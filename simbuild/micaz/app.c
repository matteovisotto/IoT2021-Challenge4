...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b9f458, const void *arg_0xb7b9f5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b508c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79fa840), 
int (*key_eq_fn)(void *arg_0xb79fac88, void *arg_0xb79fae00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78c99b8, int arg_0xb78c9b10);
static double RandomUniform(void );
...
#line 112
    {
      ...
      sim_log_debug(153U, "radio_rec", "Received packet at time %s\n", sim_time_string());
      sim_log_debug(154U, "radio_pack", "Pack \n \t Payload length %hhu \n", sendAckC$Packet$payloadLength(buf));

      sim_log_debug_clear(155U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(156U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint8(rcm->msg_type.nxdata));
      sim_log_debug_clear(157U, "radio_pack", "\t\t msg_counter: %hhu \n", __nesc_ntoh_uint16(rcm->msg_counter.nxdata));
      sim_log_debug_clear(158U, "radio_pack", "\t\t value: %hhu \n", __nesc_ntoh_uint16(rcm->value.nxdata));
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb766dac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb766dac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb766dac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb766a178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb766a178, msg, payload, len);
#line 78
...
#line 60
    {
      sim_log_error(150U, "radio", "Radio error, trying to turning on again...\n");
    }
}
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb766d108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb766d108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb750c6a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb750c6a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb750c6a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7825650){
#line 75
  switch (arg_0xb7825650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7825650);
#line 75
      break;
#line 75
    }
...
#line 162
  ...
  if (sendAckC$AMSend$send(0, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug(164U, "Radio", "Message sent!\n");
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb738d3a8){
#line 83
  switch (arg_0xb738d3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb738d3a8);
#line 83
      break;
#line 83
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb750b0a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb750b0a0, addr, msg, len);
#line 80
...
#line 87
  ...
  if (&sendAckC$packet[sim_node()] == buf) {
      ...
      sim_log_debug(151U, "radio_send", "Packet sent...");
      sim_log_debug_clear(152U, "radio_send", " at time %s \n", sim_time_string());
    }
}
