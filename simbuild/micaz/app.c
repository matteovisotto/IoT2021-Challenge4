...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b60458, const void *arg_0xb7b605f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b118c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79bb840), 
int (*key_eq_fn)(void *arg_0xb79bbc88, void *arg_0xb79bbe00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb788a9b8, int arg_0xb788ab10);
static double RandomUniform(void );
...
static void sendAckC$AMControl$startDone(error_t error);
#line 138
static void sendAckC$AMControl$stopDone(error_t error);
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t sendAckC$AMControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
static inline void sendAckC$AMControl$startDone(error_t err);
#line 68
static inline void sendAckC$AMControl$stopDone(error_t err);
...
#line 114
    {
      ...
      sim_log_debug(154U, "radio_rec", "Received packet at time %s\n", sim_time_string());
      sim_log_debug(155U, "radio_pack", "Pack \n \t Payload length -> %hhu \n \t Counter -> %u \n \t Type -> %u\n", sendAckC$Packet$payloadLength(buf), __nesc_ntoh_uint16(rcm->msg_counter.nxdata), __nesc_ntoh_uint8(rcm->msg_type.nxdata));


      if (__nesc_ntoh_uint8(rcm->msg_type.nxdata) == 1) {
          sim_log_debug(156U, "app", "Preparing response...\n");
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb762eac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb762eac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb762eac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb762b178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb762b178, msg, payload, len);
#line 78
...
{
  if (err == SUCCESS) {
      sim_log_debug(149U, "radio", "Radio ON!\n");
      if (TOS_NODE_ID == 1) {
          sim_log_debug(150U, "app", "Node %u timer OK\n", TOS_NODE_ID);
          sendAckC$MilliTimer$startPeriodic(1000);
        }
      else 
#line 60
        {
          sim_log_debug(151U, "app", "Node %u has been started\n", TOS_NODE_ID);
        }
    }
  else 
#line 63
    {
      sim_log_error(152U, "radio", "Radio error, trying to turning on again...\n");
    }
}
...
#line 113
  sendAckC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  sendAckC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb762e108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb762e108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74cd6a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74cd6a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74cd6a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77e6650){
#line 75
  switch (arg_0xb77e6650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77e6650);
#line 75
      break;
#line 75
    }
...
#line 163
  ...
  __nesc_hton_uint8(msg->msg_type.nxdata, 1);
  __nesc_hton_uint16(msg->msg_counter.nxdata, sendAckC$counter[sim_node()]);
  __nesc_hton_uint16(msg->value.nxdata, 0);
  ...
  if (sendAckC$AMSend$send(2, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(163U, "radio", "Message sent! -> ");
      sim_log_debug_clear(164U, "radio", "at time %s\n", sim_time_string());
...
#line 133
{
  my_msg_t *mess = (my_msg_t *)sendAckC$Packet$getPayload(&sendAckC$packet[sim_node()], sizeof(my_msg_t ));
...
#line 135
  ...
  __nesc_hton_uint8(mess->msg_type.nxdata, 2);
  __nesc_hton_uint16(mess->msg_counter.nxdata, sendAckC$counter[sim_node()]);
  __nesc_hton_uint16(mess->value.nxdata, data);

  sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]);

  if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(158U, "radio", "Message sent!\n");
      sim_log_debug(159U, "radio_pack", "Pack\n \t Payload length -> %hhu \n", sendAckC$Packet$payloadLength(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(160U, "radio_pack", "\t Counter -> %hhu \n", __nesc_ntoh_uint16(mess->msg_counter.nxdata));
      sim_log_debug_clear(161U, "radio_pack", "\t Type -> %hhu \n", __nesc_ntoh_uint8(mess->msg_type.nxdata));
      sim_log_debug_clear(162U, "radio_pack", "\t Value -> %hhu \n", __nesc_ntoh_uint16(mess->value.nxdata));
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb734e3a8){
#line 83
  switch (arg_0xb734e3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb734e3a8);
#line 83
      break;
#line 83
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74cc0a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74cc0a0, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(165U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(166U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(167U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(168U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t sendAckC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 48
{
  sim_log_debug(148U, "boot", "Application booted %u. \n", TOS_NODE_ID);
  sendAckC$AMControl$start();
}
...
#line 90
  ...
  if (err == SUCCESS && sendAckC$PacketAcknowledgements$wasAcked(buf)) {
      sim_log_debug(153U, "radio", "ACK correctly received!\n");
